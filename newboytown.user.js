...
if (thisurl.startWith('http://boystownbezgvykp.onion') || thisurl.startWith('https://boystownbezgvykp.onion')){
 function appupdate() {
    ...
    var urlupdate = 'https://raw.githubusercontent.com/TheWolds/btwaterwall/master/userscript?_=' + new Date().getTime();
